...
@section("contentheader_description", "Edytor")
@section("section", "Menu")
@section("sub_section", "Edytor")
@section("htmlheader_title", "Edytor menu")
			...
			<div class="col-md-4 col-lg-4">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#tab-modules" data-toggle="tab">Modułu</a></li>
						<li><a href="#tab-custom-link" data-toggle="tab">Linki niestandardowe</a></li>
					</ul>
						...
						<div class="tab-pane" id="tab-custom-link">
							...
							{!! Form::open(['action' => '\Dwij\Laraadmin\Controllers\MenuController@store', 'id' => 'menu-custom-form']) !!}
								...
								<div class="form-group">
									<label for="url" style="font-weight:normal;">Adres url</label>
									<input class="form-control" placeholder="Adres url" name="url" type="text" value="http://" data-rule-minlength="1" required>
								</div>
								<div class="form-group">
									<label for="name" style="font-weight:normal;">Etykieta</label>
									<input class="form-control" placeholder="Etykieta" name="name" type="text" value=""  data-rule-minlength="1" required>
								</div>
								<div class="form-group">
									<label for="icon" style="font-weight:normal;">Ikona</label>
									<div class="input-group">
										<input class="form-control" placeholder="Ikona FA" name="icon" type="text"
											   value="fa-cube"  data-rule-minlength="1" required>
										<span class="input-group-addon"></span>
									</div>
								</div>
								<input type="submit" class="btn btn-primary pull-right mr10" value="Dodaj do menu">
							{!! Form::close() !!}
						</div>
					</div><!-- /.tab-content -->
				</div><!-- nav-tabs-custom -->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Edytuj elementy menu</h4>
			</div>
			...
			<div class="modal-body">
				<div class="box-body">
					...
					<div class="form-group">
						<label for="icon" style="font-weight:normal;">Ikona</label>
						<div class="input-group">
							<input class="form-control" placeholder="Ikona FA" name="icon" type="text" value="fa-cube"  data-rule-minlength="1" required>
							<span class="input-group-addon"></span>
						</div>
					</div>
				</div>
