...
@section("contentheader_title", "Spółki Partnerskie Partnerships")
...
@section("headerElems")
@la_access("Partnerships", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Dodaj spółkę partnership</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Dodaj społkę partnership</h4>
			</div>
			{!! Form::open(['action' => 'LA\PartnershipsController@store', 'id' => 'partnership-add-form']) !!}
...
$(function () {
	...
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/partnership_dt_ajax') }}",
		language: {
