...
@section('htmlheader_title') Panel główny @endsection
@section('contentheader_title') Panel główny @endsection
@section('contentheader_description') Przegląd @endsection
			...
			@foreach ($menuItems as $menu)
				@if($menu->type == "module")
					...
					@if(isset($module->id) && $module->name == $menu->name)
                        <?php echo LAHelper::print_menu_dashboard($menu ,true); ?>
					@else
                        <?php echo LAHelper::print_menu_dashboard($menu); ?>
					@endif
					@endla_access
				@else
                    <?php echo LAHelper::print_menu_dashboard($menu); ?>
