...
@section("contentheader_title", "Prcownicy")
@section("contentheader_description", "Lista pra")
@section("section", "Pracownicy")
@section("sub_section", "Lista")
@section("htmlheader_title", "Lista pracokników")

@section("headerElems")
@la_access("Employees", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Dodaj
		pracownika</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Dodaj praconika</h4>
			</div>
