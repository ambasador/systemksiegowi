...
<div id="page-content" class="profile2">
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/permissions') }}" data-toggle="tooltip"
						data-placement="right" title="Powrót do uprawnień"><i class="fa fa-chevron-left"></i></a></li>
					...
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-md-10 fvalue star_class">
									<input class="btn btn-success" type="submit" value="Zachowaj">
								</div>
							</div>
						</div>
					</form>
