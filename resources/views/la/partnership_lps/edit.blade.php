...
@section("contentheader_title")
	<a href="{{ url(config('laraadmin.adminRoute') . '/partnership_lps') }}">Partnership LP</a> :
@endsection
@section("contentheader_description", $partnership_lp->$view_col)
@section("section", "Partnership LPs")
@section("section_url", url(config('laraadmin.adminRoute') . '/partnership_lps'))
@section("sub_section", "Edit")

@section("htmlheader_title", "Partnership LPs Edit : ".$partnership_lp->$view_col)
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					{!! Form::model($partnership_lp, ['route' => [config('laraadmin.adminRoute') . '.partnership_lps.update', $partnership_lp->id ], 'method'=>'PUT', 'id' => 'partnership_lp-edit-form']) !!}
					@la_form($module)
					...
					<div class="form-group">
						{!! Form::submit( 'Akuzalizuj', ['class'=>'btn btn-success']) !!} <button class="btn
						btn-default pull-right"><a href="{{ url(config('laraadmin.adminRoute') . '/partnership_lps')
						}}">Anuluj</a></button>
					</div>
...
<script>
    $(function () {
        ...
        $("#partnership_lp-edit-form").validate({
            rules: {
                registration_date:{
                    validDate: true
                },
