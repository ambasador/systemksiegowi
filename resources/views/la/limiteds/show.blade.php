...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-7">	<h1 class="name">{{ $limited->$view_col }}</h1></div>
	
		<div class="col-md-2 actions">
			@la_access("Limiteds", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/limiteds/'.$limited->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;
			@endla_access
			
			@la_access("Limiteds", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.limiteds.destroy', $limited->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/limiteds') }}" data-toggle="tooltip" data-placement="right" title="Powrót do listy"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'address_email')
