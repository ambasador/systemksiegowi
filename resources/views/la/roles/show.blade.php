...
<div id="page-content" class="profile2">
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		...
		@role("SUPER_ADMIN")
		<li class=""><a role="tab" data-toggle="tab" href="#tab-access" data-target="#tab-access"><i class="fa
		fa-key"></i> Dostęp</a></li>
		@endrole
	</ul>
	...
	<div class="tab-content">
		...
		<div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-access">
			<div class="guide1">
				<span class="pull-left">Dostęp do modułu dla {{ $role->display_name }} role</span>
				<i class="fa fa-circle gray"></i> Niewidzalny <i class="fa fa-circle orange"></i> Do odczytu <i
						class="fa fa-circle green"></i> Zapis
			</div>
			<form action="{{ url(config('laraadmin.adminRoute') . '/save_module_role_permissions/'.$role->id) }}" method="post">
				...
				<table class="table table-bordered dataTable no-footer table-access">
					<thead>
						<tr class="blockHeader">
							<th width="30%">
								<input class="alignTop" type="checkbox" id="module_select_all" id="module_select_all"
									   checked="checked">&nbsp; Moduły
							</th>
							<th width="14%">
								<input type="checkbox" id="view_all" checked="checked">&nbsp; Przegląd
							</th>
							<th width="14%">
									<input type="checkbox" id="create_all" checked="checked">&nbsp; Tworzenie
							</th>
							<th width="14%">
								<input type="checkbox" id="edit_all" checked="checked">&nbsp; Edycja
							</th>
							<th width="14%">
							<input class="alignTop" id="delete_all" type="checkbox"  checked="checked">&nbsp; Usuwanie
							</th>
							<th width="14%">Przywileje pola</th>
						</tr>
					</thead>
				...
				<center><input class="btn btn-success" type="submit" name="Zachowaj"></center>
			</form>
